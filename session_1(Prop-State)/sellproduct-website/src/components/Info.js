...
import { ImagesInfo } from "../assets/Images"
                        ...
                        <div className="row">
                            <div className="col-md-9">
                                <div className="app_container">
                                    ...
                                    <div>
                                        <img src={ImagesInfo.imgGoogle} alt="" />
                                        <img src={ImagesInfo.imgApple} alt="" />
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-3">
                                <div className="info_social">
                                    <div>
                                        <a href="">
                                            <img src={ImagesInfo.imgFB} alt="" />
                                        </a>
                                    </div>
                                    <div>
                                        <a href="">
                                            <img src={ImagesInfo.imgTwitter} alt="" />
                                        </a>
                                    </div>
                                    <div>
                                        <a href="">
                                            <img src={ImagesInfo.imgLinkedin} alt="" />
                                        </a>
                                    </div>
                                    <div>
                                        <a href="">
                                            <img src={ImagesInfo.imgInstagram} alt="" />
                                        </a>
                                    </div>
                                </div>
                            </div>
